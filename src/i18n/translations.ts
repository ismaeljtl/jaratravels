...
export const translations = {
  pt: {
    ...
    cookieSettings: {
      ...
      description: "Escolha quais cookies pretende aceitar. Pode alterar estas preferências a qualquer momento.",
      essential: "Cookies Essenciais",
      essentialDesc: "Necessários para o funcionamento básico do site. Não podem ser desativados.",
      analytics: "Cookies de Análise",
      analyticsDesc: "Ajudam-nos a entender como os visitantes interagem com o site.",
      marketing: "Cookies de Marketing",
      marketingDesc: "Utilizados para mostrar anúncios relevantes e medir campanhas.",
  ...
  en: {
    ...
    services: {
      ...
      guidedToursDesc: "Explore amazing destinations with a specialized guide and carefully planned itineraries",
    ...
    cookieSettings: {
      ...
      description: "Choose which cookies you want to accept. You can change these preferences at any time.",
      ...
      marketingDesc: "Used to show relevant ads and measure campaigns.",
  ...
  es: {
    ...
    services: {
      ...
      guidedTours: "Tours Guiados",
      guidedToursDesc: "Explore destinos increíbles con un guía especializado e itinerarios cuidadosamente planificados",
    ...
    cookieSettings: {
      ...
      description: "Elige qué cookies deseas aceptar. Puedes cambiar estas preferencias en cualquier momento.",
      ...
      marketing: "Cookies de Marketing",
      marketingDesc: "Utilizadas para mostrar anuncios relevantes y medir campañas.",
